...
<link rel="stylesheet" type="text/css" href="public/styles/events.css">
<link rel="stylesheet" type="text/css" href="public/styles/events_responsive.css">
</head>
<body>
...
<?php
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="public/images/events.jpg" data-speed="0.8"></div>
						...
						<div class="row">
							<div class="col">
								<div class="header_top_content d-flex flex-row align-items-center justify-content-start">
									...
									Hi !! <span style="color:black;"><?php echo $_SESSION["loggedUser"]->getFullName()?> </span>
									</div>
	...
	<!-- Events -->
	<?php
		$eventData = Event::createInstance();
		$events = $eventData ->getAllActiveEvents();
	?>
	<div class="events">
		<div class="container">
			<div class="row">
						...
						<div class="row row-lg-eq-height">
							<div class="col-lg-6 event_col">
								<div class="event_image_container">
									<div class="background_image" style="background-image:url(<?php echo $event->getPicture();?>)"></div>
									<div class="date_container">
										<a href="#">
											<span class="date_content d-flex flex-column align-items-center justify-content-center">
												<div class="date_day"><?php echo date("d", strtotime($event->getStartingDateTime()));?></div>
												<div class="date_month"><?php echo date("M", strtotime($event->getStartingDateTime()));?></div>
											</span>
										</a>	
									</div>
								</div>
							...
							<div class="col-lg-6 event_col">
								<div class="event_content">
									...
									<div class="event_location">@ <?php echo $event->getVenue();?></div>
									...
									<div class="event_speakers">
										...
										<div class="event_speaker d-flex flex-row align-items-center justify-content-start">
											<div><div class="event_speaker_image"><img src="public/images/event_speaker_1.jpg" alt=""></div></div>
											<div class="event_speaker_content">
												<div class="event_speaker_name"><?php echo $event->getSpeaker1();?></div>
												<div class="event_speaker_title"><?php echo $event->getSTitle1();?></div>
											</div>
										</div>
										<!-- Event Speaker -->
										<div class="event_speaker d-flex flex-row align-items-center justify-content-start">
											<div><div class="event_speaker_image"><img src="public/images/event_speaker_2.jpg" alt=""></div></div>
											<div class="event_speaker_content">
												<div class="event_speaker_name"><?php echo $event->getSpeaker2();?></div>
												<div class="event_speaker_title"><?php echo $event->getSTitle2();?></div>
											</div>
										</div>
									</div>
									...
									<div class="event_buttons">
										<?php
											$eventRegisterData = EventRegistry::createInstance();
											$eventRegister 
											= $eventRegisterData->getUserEvent($_SESSION["loggedUser"]->getId(),$event->getId());
										?>
										<?php
										 	if($eventRegister == null){
										?>
										<form method="POST" action="/events/app/controller/EventsController.php/RegisterEvent" class="register_event_form">
												<input type="hidden" value="<?php echo $_SESSION["loggedUser"]->getId()?>" name="user_Id">
												<input type="hidden" value="<?php echo $event->getId()?>" name="event_Id">
												<input class="event_button event_button_1" style="background:#86D6E4   ; color :white; padding: 10px; font-weight: bold;" type="submit" value="Registe Now!">
										</form>		
										<?php }else{?>
												<?php if($eventRegister->getComplete()==1)
												      {?>
													<div class="event_button event_button_1" style="background:#83CF7E ; color :white; padding: 10px; font-weight: bold;"><a href="#">Your Registered!</a></div>
												<?php }else{?>
													<div class="event_button event_button_1" style="background:#DBDE2A ; color :white; padding: 10px; font-weight: bold;"><a href="#">Pending Request </a></div>
													<?php }?>
										<?php }?>
									</div>
								</div>
	...
	<div class="cta">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="public/images/cta_1.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
