			...
			<div class="row">
				<div class="col-lg-6">
					<div class="contact_form_container">
						<div class="contact_form_title">Register with us</div>
						<span style="color:red">
						  <?php
						  
						  	  $user = new User("","","","","","");
							  if(isset($_SESSION["registerFormData"]))
								 $user = $_SESSION["registerFormData"];

							  if(isset($_SESSION["RegisterFormErrors"]))
							     echo "Error :- ".$_SESSION["RegisterFormErrors"];
						  ?>
					     	
						</span>
						<form method="POST" action="/events/app/controller/UserController.php/Register" class="contact_form" id="contact_form">
							<input type="text" class="contact_input" placeholder="Name" required="required" name="FullName" value="<?=$user->getFullName()?>">
							<input type="email" class="contact_input" placeholder="E-mail" required="required" name="Email" value="<?=$user->getEmail()?>">
							<input type="password" class="contact_input" placeholder="Password" required="required" name="Password" value="<?=$user->getPassword()?>">
							<input type="password" class="contact_input" placeholder="Re-password" required="required" name="Repassword" value="<?=$user->getRepassword()?>">
							<input type="text" class="contact_input" placeholder="Contact" required="required" name="ContactNo" value="<?=$user->getContactNo()?>">
			                <input type="text"class="contact_input" placeholder="Address" required="required"  name="Address"  value="<?=$user->getAddress()?>">
							<button  type="submit" name="submit"  class="button contact_button" value="Submit"><span>Register</span></button>
						</form>
					</div>
				</div>
