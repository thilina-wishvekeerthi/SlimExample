...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				<li class="menu_item"><a href="index.html">Admin - User - MGT</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content d-flex flex-row align-items-end justify-content-start">
							<div class="current_page">ADMIN User Mgt</div>
		...
		<div style="margin-left: 20px;">
			<div class="row">
				...
				<div class="col-lg-9 " style="color: black">
					<h2>System Users</h2>
					<p>Below you can manage system users</p>         
					<br>                                                                             
					...
					<table class="table">
					  ...
					  <tbody>
						  ...
						  <?php foreach($users as $user){?>
								...
								<td >
									<form method="POST" action="/events/app/controller/UserController.php/DeActiveUser">
                                ...
                                <?php } else {?>
                                    <td>
                                    <form method="POST" action="/events/app/controller/UserController.php/ActiveUser">
										<input type="hidden" value="<?php echo $user["Id"]?>" name="UserId">
								...
								<td >
									<form method="POST" action="/events/app/controller/UserController.php/NoAdminUser">
										<input type="hidden" value="<?php echo $user["Id"]?>" name="UserId">
                                ...
                                <?php } else {?>
                                    <td>
                                        <form method="POST" action="/events/app/controller/UserController.php/AdminUser">
                                            <input type="hidden" value="<?php echo $user["Id"]?>" name="UserId">
