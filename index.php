...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="public/images/index.jpg" data-speed="0.8"></div>
					...
					<div class="col">
						<div class="home_content">
							...
							<div class="home_buttons">
							                        <?php if($userLogged){?>
														<div class="button home_button"><a href="events.php">Events</a></div>
												    <?php }else{?>
														<div class="button home_button"><a href="register.php">Register</a></div>
													<?php }?>
					...
					<div class="col">
						<div class="footer_extra_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-start justify-content-center">
							<div class="footer_social">
								<div class="footer_social_title">Register with us for the conference</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Anushka</a>
